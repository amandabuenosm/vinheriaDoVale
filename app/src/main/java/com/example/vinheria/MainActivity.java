...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mainvendedor), (v, insets) -> {
        ...
        Button manutencaoPedidos = findViewById(R.id.manutencaoPedidos);

        manutencaoPedidos.setOnClickListener(v -> {
